            ...
            if(numrows($rs) > 0){
                        ...
                        while($record = dofetch($records)){
                            ...
                            <tr>
                                ...
                                for($i = 0; $i < 2; $i++){
                                    ...
                                    $totals[$i]['t'] += $t;
                                    ?>
                                    <td class="text-center color-<?php echo $i?>"><?php echo $t?></td>
                                    <?php
                                }
                                $t = 0;
                                foreach($sizes as $size_id => $size){
                                ...
                                $totals[2]['t'] += $t;
                                ?>
                                <td class="text-center color-2"><?php echo $t?></td>
                            </tr>
                            <?php
                            $sn++;
                        }
                ...
                <tr>
                    ...
                    for($i = 0; $i < 3; $i++){
                        foreach($sizes as $size_id => $size){
                            ?>
                            <td class="text-center"><?php echo $totals[$i][$size_id]?></td>
                            <?php
                        }
                        ?>
                        <td class="text-center color-<?php echo $i?>"><?php echo $totals[$i]['t']?></td>
                        <?php
                    }
                    ?>
                </tr>
