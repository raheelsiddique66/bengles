...
?>
<div ng-app="production" ng-controller="productionController" id="productionController">
    ...
    <div class="form-horizontal">
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-sm-10">
                    <input ng-model="production.date" class="form-control date-picker" />
                </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-2 control-label">
                    <label class="form-label" for="production.gatepass_id">Gatepass ID</label>
                </div>
                <div class="col-sm-10">
                        ...
                        <table class="table table-hover list">
                            ...
                            <tbody>
                                <tr ng-repeat="production_item in production.production_items">
                                    ...
                                    <td>
                                        <select title="Choose Option" ng-model="production.production_items[$index].machine_id">
                                            <option value="0">Select Machine</option>
                                            <option ng-repeat="machine in machines" value="{{ machine.id }}">{{ machine.title }}</option>
                                        </select>
                                    </td>
                                    <td>
                                        <select title="Choose Option" ng-model="production.production_items[$index].color_id">
                                            <option value="">Select Color</option>
                                            <option ng-repeat="color in colors" value="{{ color.id }}">{{ color.title }}</option>
                                        </select>
                                    </td>
                                    <td>
                                        <select title="Choose Option" ng-model="production.production_items[$index].design_id">
                                            <option value="">Select Design</option>
                                            <option ng-repeat="design in designs" value="{{ design.id }}">{{ design.title }}</option>
                                        </select>
                                    </td>
                                    <td class="text-right" ng-repeat="size in sizes"><input type="text" ng-model="production.production_items[$parent.$index].quantity[size.id]" /></td>                        
