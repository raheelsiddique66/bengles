...
if(isset($_SESSION["color_manage"]["add"])){
	extract($_SESSION["color_manage"]["add"]);	
}
else{
	$title="";
    $title_urdu="";
...
<form class="form-horizontal form-horizontal-left" role="form" action="color_manage.php?tab=add" method="post" enctype="multipart/form-data" name="frmAdd"  onSubmit="return checkFields();">
    <?php
        $i=0;
    ?>
    ...
    <div class="form-group">
    	<div class="row">
            ...
            <div class="col-sm-10">
                <input type="submit" value="SUBMIT" class="btn btn-default btn-l" name="color_add" title="Submit Record" />
            </div>
        </div>
  	</div>  
</form>