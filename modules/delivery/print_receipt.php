...
<div id="main">
    ...
    <div class="contentbox">
        ...
        <table class="table table-hover list">
            ...
            <?php
            $rs1 = doquery( "select *, group_concat(concat(size_id, 'x', quantity)) as sizes from delivery_items where delivery_id='".$delivery[ "id" ]."' group by color_id,design_id", $dblink );
            if(numrows($rs1)>0){
				$price = 0;
				$total_price = 0;
                $totals = [];
