...
if( numrows( $rs ) > 0 ) {
	...
	while( $r = dofetch( $rs ) ) {
		...
		<tr>
            ...
            <th class="text-right bg-grey"><?php echo curr_format($balance)?></th>
            <th class="text-right bg-grey"><?php echo curr_format($income)?></th>
            <th class="text-right bg-grey"><?php echo curr_format($total_amount+$balance-$income)?></th>
        </tr>
		<?php
		$sn++;
	}
...
<tr>
    ...
    <th class="text-right bg-grey"><?php echo curr_format($total_balance)?></th>
    <th class="text-right bg-grey"><?php echo curr_format($total_income)?></th>
    <th class="text-right bg-grey"><?php echo curr_format($grand_total_amount+$total_balance-$total_income)?></th>
</tr>
</table>
<?php
die;
