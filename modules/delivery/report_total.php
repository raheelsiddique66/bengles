...
$sql = "SELECT a.*, group_concat(a.id)  as delivery_ids, b.balance, b.customer_name FROM `delivery` a left join customer b on a.customer_id = b.id  WHERE 1 $extra and b.status = 1 group by customer_id order by customer_name";
