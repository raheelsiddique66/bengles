...
<form class="form-horizontal form-horizontal-left" role="form" action="size_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd">
    ...
    <div class="form-group">
    	<div class="row">
            ...
            <div class="col-sm-10">
                <input type="submit" value="Update" class="btn btn-default btn-l" name="size_edit" title="Update Record" />
            </div>
        </div>
  	</div>
</form>