...
<div class="page-header">
	<h1 class="title">Manage Vendor Outgoing</h1>
  	<div class="right">
    	<div class="btn-group" role="group" aria-label="...">
            <a href="vendor_outgoing_manage.php?tab=new_vendor_outgoing" class="btn btn-light editproject">Multiple Vendor Outgoing</a>
        	<a href="vendor_outgoing_manage.php?tab=addedit" class="btn btn-light editproject">Add New Vendor Outgoing</a>
            <a id="topstats" class="btn btn-light" href="#"><i class="fa fa-search"></i></a>
            <a class="btn print-btn" href="vendor_outgoing_manage.php?tab=report"><i class="fa fa-print" aria-hidden="true"></i></a>
            <a href="vendor_outgoing_manage.php?tab=report_total" class="btn btn-light editproject">Report Total</a>
        </div>
  	</div>
</div>
	...
	<table class="table table-hover list">
    	<thead>
            <tr>
                ...
                <th width="13%" class="text-right">Vendor</th>
    	...
    	<tbody>
            ...
            if(numrows($rs)>0){
                ...
                while($r=dofetch($rs)){
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="vendor_outgoing_manage.php?id=<?php echo $r['id'];?>&tab=status&s=<?php echo ($r["status"]==0)?1:0;?>">
                                <?php
                                if($r["status"]==0){
                                    ?>
                        ...
                        <td class="text-center">
                            <a href="vendor_outgoing_manage.php?tab=addedit&id=<?php echo $r['id'];?>"><img title="Edit Record" alt="Edit" src="images/edit.png"></a>&nbsp;&nbsp;
                            <a onclick="return confirm('Are you sure you want to delete')" href="vendor_outgoing_manage.php?id=<?php echo $r['id'];?>&amp;tab=delete"><img title="Delete Record" alt="Delete" src="images/delete.png"></a>
                            <a href="vendor_outgoing_manage.php?tab=print_receipt&id=<?php echo $r['id'];?>"><img title="Edit Record" alt="Edit" src="images/view.png"></a>
                        </td>
                    </tr>
                    <?php
                    $sn++;
                ...
                <tr>
                    ...
                    <td colspan="4" class="paging" title="Paging" align="right"><?php echo pages_list($rows, "vendor_outgoing", $sql, $pageNum)?></td>
                </tr>
                <?php
            }
            else{
