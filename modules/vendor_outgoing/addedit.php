    ...
    <div class="form-horizontal">
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-sm-10">
                    <input ng-model="vendor_outgoing.date" class="form-control date-picker" />
                </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-2 control-label">
                    <label class="form-label" for="vendor_outgoing.gatepass_id">Gatepass </label>
                </div>
                <div class="col-sm-10">
                        ...
                        <table class="table table-hover list">
                            ...
                            <tbody>
                                <tr ng-repeat="vendor_outgoing_item in vendor_outgoing.vendor_outgoing_items">
                                    ...
                                    <td class="text-right" ng-repeat="size in sizes"><input type="text" ng-model="vendor_outgoing.vendor_outgoing_items[$parent.$index].quantity[size.id]" /></td>
