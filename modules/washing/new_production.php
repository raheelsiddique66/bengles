...
if( isset( $_GET[ "date" ] ) ) {
    $_SESSION["washing_manage"]["new_washing"]["date"] = slash( $_GET[ "date" ] );
}
if(isset($_SESSION["washing_manage"]["new_washing"])){
    extract($_SESSION["washing_manage"]["new_washing"]);
}
else{
...
<div ng-app="customerwashing" ng-controller="customerwashingController" id="customerwashingController">
    ...
    <div class="form-horizontal">
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-sm-10">
                    <input ng-model="date" class="form-control date-picker" ng-change="get_washing()" />
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-11">
                    ...
                    <table class="table table-hover list">
                            ...
                            <tbody>
                                <tr ng-repeat="washing in washings">
                                    ...
                                    <td>
                                        <table class="table table-hover list items-deliver">
                                            ...
                                            <tr ng-repeat="washing_item in washing.washing_items">
                                                <td>
                                                    <select title="Choose Option" ng-model="washing_item.machine_id">
                                                        <option value="0">Select Machine</option>
                                                        <option ng-repeat="machine in machines" value="{{ machine.id }}">{{ machine.title }}</option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <select title="Choose Option" ng-model="washing_item.design_id">
                                                        <option value="">Select Design</option>
                                                        <option ng-repeat="design in designs" value="{{ design.id }}">{{ design.title }}</option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <select title="Choose Option" ng-model="washing_item.color_id">
                                                        <option value="">Select Color</option>
                                                        <option ng-repeat="color in colors" value="{{ color.id }}">{{ color.title }}</option>
                                                    </select>
                                                </td>
                                                <td class="text-right" ng-repeat="size in sizes"><input type="text" ng-model="washing_item.quantity[size.id]" /></td>                        
