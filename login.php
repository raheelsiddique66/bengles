	...
	<div id="content">
        	<div class="login-form">
                <form name="loginfrm" method="post">
                    <div class="top">
                        <h1><?php $login_logo=get_config("login_logo"); if(empty($login_logo)) echo $site_title; else { ?><img src="<?php echo $file_upload_root;?>config/<?php echo $login_logo?>" width="50" style="margin-right:5px" /><?php echo $site_title; }?></h1>
