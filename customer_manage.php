...
$tab_array=array("list", "add", "edit", "status", "delete", "bulk_action", "report", "print", "print_ledger", "balance_report", "customer_dashboard");
...
switch($tab){
    ...
    break;
    case 'print_ledger':
        include("modules/customer/print_ledger.php");
    break;
}
?>
